#%%
from configuration_error_check import configuration_check
...
nerr, mz1, mz2, PI = configuration_check(TMR, Ki, Rp, Ms)

if nerr == -1:
    print('numerical error, do not use parameters! Following messages are irrelevant')
else:
    print('configuration is physical')
